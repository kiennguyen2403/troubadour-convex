...
export default function History(props) {
        ...
        <Box>
            ...
            <Grid container spacing={2}>
                {library.length > 0 ? library.map((item) =>
                    <Grid item xs={4}>
                        <VideoButton image={item.image} title={item.title} description={item.description} eventHandler={getMedias} />
                    </Grid>) : <Typography textAlign="center" width="100%" gutterBottom marginTop="5%" marginBottom="5%">
    ...
    return (
        <ClippedDrawer Component={[Recently, Playlist]} />
    )
}