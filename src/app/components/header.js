...
import { MediaDetail } from "@/app/components/media-details";
import Confirm from "@/app/components//confirm";
import { LiveDetail } from "@/app/components/live-detail";
import LiveConfirm from "@/app/components/live-confirm";
...
export default function ClippedDrawer({ Component }) {
            ...
            <ListItem key={text.title} disablePadding>
                <ListItemButton onClick={() => {
                    if (text.title === "Home")
                        ...
                        router.push("/" + text.title.toLowerCase())
                }}>
                    <ListItemIcon>
                        {text.component}
                    </ListItemIcon>
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <MediaControl />
            {isOptionLoginOpen ? <OptionLoginBox setIsOptionOpen={setIsOptionLoginOpen} /> : null}
            {isOptionUploadOpen ? <OptionNewVideoBox
                setIsOptionOpen={setIsOptionUploadOpen}
                setIsMultipleFormOpen={setIsMultipleFormOpen}
                setIsLiveMultipleFormOpen={setIsLiveMultipleFormOpen} /> : null}
            <MultipleStepForm
