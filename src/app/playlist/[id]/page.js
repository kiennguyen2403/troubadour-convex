    ...
    const Information =
        <Box sx={{ flexGrow: 1, opacity: "0.5", }}>
            <Grid container  >
                ...
                <Grid item xs={8} >
                    <Typography variant="h4" component="div" gutterBottom textAlign="left" marginLeft="2%" marginTop="8%" onClick={() => { setIsEditOpen(true); console.log("hello") }}>
                        Title
                    </Typography>
                    <Typography variant="body2" gutterBottom textAlign="left" marginLeft="2%" onClick={() => { setIsEditOpen(true); }}>
                        Description
                    </Typography>
                </Grid>

            </Grid>
            <DetailModal isOpen={isEditOpen} setIsOpen={setIsEditOpen} title={title} description={description} image={image} />
        </Box>
                                ...
                                >
                                    ...
                                    <TableCell align="left">
                                        <Grid container spacing={2}>
                                            ...
                                            <Grid item xs={10}>
                                                <Typography variant="subtitle1" gutterBottom textAlign="left" marginLeft="2%">
                                                    {item.title}
                                                </Typography>
